    ...
    let data = {
        ...
        WhatsappMessage(data).then(response => {
          if (response.data) {
            ...
            getMediaFiles(response.data, video, setVideo,
              audio, setAudio, image, setImage,
              user.usertoken)
          }
          if (response.error) {
    ...
    <ScrollView>
      ...
      <View style={globalStyles.dashboardContainer}>
        <View style={{ gap: 8, width: "100%" }}>
          ...
          {mgs.data && mgs.data.map((message, index) => {
            ...
            switch (message.record_type) {
              case 'text':
                return (
                  ...
                  style={[
                    ...
                    <Text
                    style= {message.context != 'medical_practitioner' && { color: 'blue' }}
                    >
              ...
              case 'image':
                return (
                  ...
                  <TouchableOpacity key={index} onPress={() => setSelectedImage('')}>
                    <Image
                        source={{
